        ...
        <section className="soc-glass mx-auto w-full max-w-md p-8 shadow-card">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input className="soc-input" placeholder="Choose username" value={username} onChange={(event) => setUsername(event.target.value)} />
            </div>
            <div>
            ...
            <button
              ...
              disabled={!name.trim() || !username.trim() || !password.trim() || submitting}
            >
