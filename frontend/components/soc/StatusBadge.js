const toneMap = {
  ...
  pending_approval: 'bg-[rgba(173,198,255,0.12)] text-[#adc6ff] border border-[rgba(173,198,255,0.22)]',
  approved: 'bg-[rgba(74,225,118,0.12)] text-[#4ae176] border border-[rgba(74,225,118,0.22)]',
  rejected: 'bg-[rgba(255,179,173,0.12)] text-[#ffb3ad] border border-[rgba(255,179,173,0.2)]',
  auto_executed: 'bg-[rgba(255,179,173,0.12)] text-[#ffb3ad] border border-[rgba(255,179,173,0.2)]',
